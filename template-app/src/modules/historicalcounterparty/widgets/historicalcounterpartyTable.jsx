...
import { historicalcounterpartyTableSchema, historicalcounterpartyFormSchema } from '../schemas.js'
import { historicalcounterpartyStore } from '../store'
...
function EntityTable() {
  ...
  return (
    <div className="historicalcounterparty-table">
      <div className="historicalcounterparty-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      <DynamicTable
        schema={historicalcounterpartyTableSchema}
      ...
      {isOpen && (
        <div className="historicalcounterparty-table__modal">
          <div className="historicalcounterparty-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="historicalcounterparty-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="historicalcounterparty-table__cancel"
