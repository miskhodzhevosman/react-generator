...
import { historicalprojectitemTableSchema, historicalprojectitemFormSchema } from '../schemas.js'
import { historicalprojectitemStore } from '../store'
...
function EntityTable() {
  ...
  return (
    <div className="historicalprojectitem-table">
      <div className="historicalprojectitem-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      <DynamicTable
        schema={historicalprojectitemTableSchema}
      ...
      {isOpen && (
        <div className="historicalprojectitem-table__modal">
          <div className="historicalprojectitem-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="historicalprojectitem-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="historicalprojectitem-table__cancel"
