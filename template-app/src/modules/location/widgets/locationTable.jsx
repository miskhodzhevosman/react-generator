...
import { locationTableSchema, locationFormSchema } from '../schemas.js'
...
function EntityTable() {
  ...
  return (
    <div className="location-table">
      <div className="location-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      {isOpen && (
        <div className="location-table__modal">
          <div className="location-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="location-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="location-table__cancel"
