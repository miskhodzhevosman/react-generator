...
function EntityTable() {
  ...
  return (
    <div className="factoryfile-table">
      <div className="factoryfile-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      {isOpen && (
        <div className="factoryfile-table__modal">
          <div className="factoryfile-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="factoryfile-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="factoryfile-table__cancel"
