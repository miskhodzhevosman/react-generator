...
import { financeoperationtypeTableSchema, financeoperationtypeFormSchema } from '../schemas.js'
import { financeoperationtypeStore } from '../store'
...
function EntityTable() {
  ...
  return (
    <div className="financeoperationtype-table">
      <div className="financeoperationtype-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      <DynamicTable
        schema={financeoperationtypeTableSchema}
      ...
      {isOpen && (
        <div className="financeoperationtype-table__modal">
          <div className="financeoperationtype-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="financeoperationtype-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="financeoperationtype-table__cancel"
