...
import { financialtransactionTableSchema, financialtransactionFormSchema } from '../schemas.js'
import { financialtransactionStore } from '../store'
...
function EntityTable() {
  ...
  return (
    <div className="financialtransaction-table">
      <div className="financialtransaction-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      <DynamicTable
        schema={financialtransactionTableSchema}
      ...
      {isOpen && (
        <div className="financialtransaction-table__modal">
          <div className="financialtransaction-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="financialtransaction-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="financialtransaction-table__cancel"
