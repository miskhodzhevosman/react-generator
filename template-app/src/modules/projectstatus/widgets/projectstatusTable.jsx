...
import { projectstatusTableSchema, projectstatusFormSchema } from '../schemas.js'
import { projectstatusStore } from '../store'
...
function EntityTable() {
  ...
  return (
    <div className="projectstatus-table">
      <div className="projectstatus-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      <DynamicTable
        schema={projectstatusTableSchema}
        title='projectstatus'
        data={items}
        loading={loading}
      ...
      {isOpen && (
        <div className="projectstatus-table__modal">
          <div className="projectstatus-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="projectstatus-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="projectstatus-table__cancel"
