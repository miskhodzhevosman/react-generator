...
import { nomenclatureimageTableSchema, nomenclatureimageFormSchema } from '../schemas.js'
import { nomenclatureimageStore } from '../store'
...
function EntityTable() {
  ...
  return (
    <div className="nomenclatureimage-table">
      <div className="nomenclatureimage-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      <DynamicTable
        schema={nomenclatureimageTableSchema}
      ...
      {isOpen && (
        <div className="nomenclatureimage-table__modal">
          <div className="nomenclatureimage-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="nomenclatureimage-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="nomenclatureimage-table__cancel"
