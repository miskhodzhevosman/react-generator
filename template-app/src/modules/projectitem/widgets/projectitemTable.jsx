...
import { projectitemTableSchema, projectitemFormSchema } from '../schemas.js'
import { projectitemStore } from '../store'
...
function EntityTable() {
  ...
  return (
    <div className="projectitem-table">
      <div className="projectitem-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      {isOpen && (
        <div className="projectitem-table__modal">
          <div className="projectitem-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="projectitem-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="projectitem-table__cancel"
