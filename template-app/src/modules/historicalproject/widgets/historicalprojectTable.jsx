...
import { historicalprojectTableSchema, historicalprojectFormSchema } from '../schemas.js'
import { historicalprojectStore } from '../store'
...
function EntityTable() {
  ...
  return (
    <div className="historicalproject-table">
      <div className="historicalproject-table__toolbar">
        <SearchInput
          value={q}
          onChange={setQuery}
      ...
      <DynamicTable
        schema={historicalprojectTableSchema}
      ...
      {isOpen && (
        <div className="historicalproject-table__modal">
          <div className="historicalproject-table__modal-backdrop" onClick={() => setForm(null)} />

          <div className="historicalproject-table__modal-body">
            <DynamicForm
              key={formKey}
            ...
            <button
              type="button"
              className="historicalproject-table__cancel"
